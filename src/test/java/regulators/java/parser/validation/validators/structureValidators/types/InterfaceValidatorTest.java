...
class InterfaceValidatorTest {
    ...
    @Test
    void validate() {
        Expression e1 = new Expression("interface cls{}", null);
        Expression e2 = new Expression(" interface cls{}", null);
        Expression e3 = new Expression("private interface clas{}", null);
        Expression e4 = new Expression("interface <..> {}", null);
        Expression e5 = new Expression("interface {}", null);

        Expression e6  = new Expression("interface cls {};", null);
        Expression e7 = new Expression("interface cls<{asd> {}", null);
        Expression e8 = new Expression("interface cls {{}", null);
        Expression e9 = new Expression("interface cls{}{}", null);
        Expression e10 = new Expression("public < interface > cls{}", null);
        Expression e11 = new Expression("interface cls {} ", null);
        Expression e12 = new Expression("xx {}", null);
        Expression e13 = new Expression("{}", null);
        Expression e14 = new Expression("class cls{}", null);
        Expression e15 = new Expression("enum cls{}", null);
        Expression e16 = new Expression("interface{}", null);
        Expression e17 = new Expression("publicinterface cls {}", null);
