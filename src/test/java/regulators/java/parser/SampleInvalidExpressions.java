...
public class SampleInvalidExpressions {
    public static final String EXPRESSION_1 = """
            ...
            imprt static org.junit.jupiter.api.Assertions.*;

            private class JavaParserTest_Types {
                ...
                static class DummyService implements ReportingService {
                    ...
                    public abstract void addExecutionReport(ExecutionReport report) {
                        this.report = report;
                    }
                }
            }""";
