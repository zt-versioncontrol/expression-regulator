...
class JsonArrayElementsExtractorTest {

    @Test
    void extractArrayFromExpression() {
        JsonArrayElementsExtractor extractor = new JsonArrayElementsExtractor();

        //simple case
        assertIterableEquals(
                List.of("abc", "def", "ghi", "jkl"),
                extractor.extractArrayFromExpression("[ abc, def, ghi, jkl\n]"));
        ...
        assertIterableEquals(
                List.of("", "", "", ""),
                extractor.extractArrayFromExpression("[,,,]"));
